 ...
 */
function paginator() {
    var perPage = arguments.length <= 0 || arguments[0] === undefined ? module.exports.count : arguments[0];
    var sortOrder = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];
    var nextID = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
